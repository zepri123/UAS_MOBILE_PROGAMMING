...
export default class LocatioScreen extends Component {

    constructor(props){
        super(props);
        this.state ={
            locationResult:null,
            mapRegion:{latitude:-7.966620,
    ...
    _getLocationAsync = async () =>{
        ...
        if (status !=='granted') {
            this.setState({
                locationResult:'permission to acces location was rejected',
                location
            });
